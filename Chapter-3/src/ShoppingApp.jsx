...
function ShoppingListApp() {
  ...
  return (
    <div>
      <div className="container mx-auto my-4 p-4 shadow-sm bg-[#112138] rounded">
        ...
        <ul>
          {items
            ...
            .map((item, index) => (
              <li key={item.id} className="py-2 border-b-[0.5px]">
                {editIndex === index ? (
                  ...
                  <div className="border-2 border-[#F60E26] rounded-lg p-4 flex items-center justify-between">
                    <input
                      type="checkbox"
